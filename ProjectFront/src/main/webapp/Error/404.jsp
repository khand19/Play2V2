...
p#detail input {
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#AE1113),
		to(#A31012) );
...
<body id="play-error-page">
	...
	<p id="detail">Erreur 404</p>
	<h2>Page introuvable</h2>
	<div id="source-code">description La ressource demandée n''est pas disponible.</div>
</body>
</html>